...
def silver_staff_dlt3():
    return (
        spark.readStream.table("bronze_staff_data")
        .select(
...
def silver_geotag_dlt3():
    return (
        spark.readStream.table("bronze_geotag_data")
        .select(
...
def silver_shipments_dlt3():
    ship_date_col = to_date(col("shipment_date"), "yy-MM-dd")    
    return (
        spark.readStream.table("bronze_shipments_data")
